...
public class ProductsModel {
    ...
    @ManyToOne
    @JoinColumn(name = "category", referencedColumnName = "cat_id", updatable = false, insertable = false)
    private CategoriesModel categoriesByCategory;
    ...
    public CategoriesModel getCategoriesByCategory() {
        return categoriesByCategory;
    }

    public void setCategoriesByCategory(CategoriesModel categoriesByCategory) {
